...
const ProductCard = (props: ProductProps) => {
  return (
    <div className='w-60 flex flex-col flex-grow basis-44 gap-3 text-xl font-inter font-medium xl:basis-auto'>
      <img className='w-full' src={props.image_url} alt={props.productName} />
      <div className='flex justify-between'>
        <h2 className='font-bold'>{props.brand} <span>{props.productName}</span></h2>
        <h2>$ {props.price}</h2>
      </div>
